...
class ManageRecipe extends SettingsPage
{
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                Section::make('Status')
                    ->description('Aktifkan atau nonaktifkan halaman resep.')
                    ->columnSpanFull()
                    ->schema([
                        ToggleButtons::make('recipe_is_active')
                ...
                Section::make('Konten')
                    ->description('Pengaturan konten untuk halaman resep.')
                    ->columnSpanFull()
                    ->schema([
                        TextInput::make('recipe_title')
                            ...
                            ->columnSpanFull()
                            ->required(),
                        TextInput::make('recipe_description')
                            ->label('Deskripsi')
                            ->autocomplete(false)
                            ->columnSpanFull()
                            ->required(),
