<div class="flex flex-col gap-4 mt-7">
    <div class="relative">
        ...
        <img class="aspect-27/16 object-cover rounded-2xl overflow-hidden" src="{{ asset('storage/' . $payload['image']) }}" alt="{{ $payload['image_alt_text'] ? $payload['image_alt_text'] : 'Langkah ' . $number . ' membuat ' . $name }}">
    </div>
    <div>
