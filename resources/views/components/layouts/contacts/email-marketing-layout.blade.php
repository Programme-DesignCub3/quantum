<div class="flex flex-col gap-5 px-4 md:p-0">
    <div class="flex justify-between gap-7">
        <div class="space-y-2">
            ...
            <p class="large break-all">{{ $page_settings->contact_email_marketing }}</p>
        </div>
    ...
    <div class="flex flex-col gap-4">
        <div class="flex flex-col gap-1">
            ...
            <div class="grid grid-cols-2 gap-2">
                @foreach($page_settings->contact_email_marketing_operational as $operational)
                    <div class="space-y-1">
        ...
        <div class="space-y-2">
            ...
            <p class="small">{{ $page_settings->contact_email_marketing_information }}</p>
        </div>
        <div class="flex justify-center py-4 md:justify-start md:pt-4 md:pb-0">
            <x-inputs.button-icon type="hyperlink" href="{{ 'mailto:' . $page_settings->contact_email_marketing }}" icon="icon-[lucide--mail]" class="rounded-2xl! md:flex-row-reverse md:gap-10">
                Email Now
