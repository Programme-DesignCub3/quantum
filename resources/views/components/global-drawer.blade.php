        ...
        <div class="flex flex-col gap-4">
            <div class="flex flex-col gap-4">
                <template x-if="$store.placeDetailDrawer.data?.image">
                    <div class="relative">
                        <img class="w-full object-cover object-bottom h-[150px] rounded-[20px] overflow-hidden" :src="$store.placeDetailDrawer.data?.image" :alt="$store.placeDetailDrawer.data?.name">
                    </div>
                </template>
                <div class="space-y-0">
