                    ...
                    <div class="splide__track">
                        <ul class="splide__list">
                            @foreach($guidances as $guidance)
                                <li class="splide__slide">
                                    <x-displays.swipe-card :image="$guidance->getMedia('thumbnail_guidance')->first() ? $guidance->getMedia('thumbnail_guidance')->first()->getUrl() : $guidance->getMedia('products')->first()->getUrl()" :alt="'Panduan ' . $guidance->variant->name . ' ' . $guidance->name">
