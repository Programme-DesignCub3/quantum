...
@section('content')
    <main x-data="privacyPolicy" class="bg-white">
        ...
        <div id="tabs-border-anchor" :class="isTop ? 'top-[68px] duration-150 delay-200' : 'top-0 duration-50'" class="sticky z-30 transition-all ease-in-out flex gap-8 w-full overflow-x-auto px-8 bg-[#F4F4F4]">
            <a href="#kebijakan-privasi" class="tab-border active">Kebijakan Privasi</a>
            <a href="#penggunaan-cookies" class="tab-border">Penggunaan Cookies</a>
        </div>
        <section id="kebijakan-privasi" class="scrollspy flex flex-col gap-6 pt-[50px] pb-20 px-6 scroll-mt-28 border-b border-[#DBDBDB]">
        ...
        <section id="penggunaan-cookies" class="scrollspy flex flex-col gap-6 pt-[50px] pb-20 px-6 scroll-mt-24">
            <div class="space-y-2.5">
