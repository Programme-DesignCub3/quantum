...
@section('content')
    <main x-data="recipeDetail" x-ref="recipeContent" id="recipe-detail" class="relative bg-[#FFFFFF] h-[800px] overflow-hidden">
        ...
        <div x-data="{ status: $store.premiumRecipeDrawer.success }" x-effect="status = $store.premiumRecipeDrawer.success">
            <x-displays.toast>
                Berhasil disimpan!
            </x-displays.toast>
        ...
        <article class="flex flex-col">
            ...
            <div class="container flex flex-col gap-12 pt-[42px] pb-24 md:px-6 md:pt-20">
                <div class="grid grid-cols-1 gap-[58px] md:grid-cols-12 sm:gap-6 lg:gap-10">
                    ...
                    <div class="flex flex-col gap-4 col-span-full md:col-span-8">
                        <h3 class="px-6 md:px-0">Cara membuat:</h3>
                        <div class="splide how-to-step md:hidden" role="group" aria-label="How to Step Slides">
                            <div class="splide__track">
                                <ul class="splide__list">
                                    @foreach($detail->steps as $index => $item)
                                        <li wire:key="step-{{ $index + 1 }}" class="splide__slide w-[260px]">
                        ...
                        <div class="hidden grid-cols-2 gap-5 md:grid">
                            @foreach($detail->steps as $index => $item)
                        ...
                        <div class="flex flex-col gap-2.5 px-6 mt-8 md:px-0">
                    ...
                    <div class="splide__track">
                        <ul class="splide__list">
                            @foreach($other_recipes as $item)
                                <li wire:key="other-recipe-{{ $item->id }}" class="splide__slide w-[260px]">
