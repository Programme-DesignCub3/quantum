<div x-show="currentTab === 'service-center'" class="container flex flex-col gap-[42px] px-4 pt-10 pb-[52px] sm:px-6 md:py-16">
    <div class="flex flex-col gap-[52px]">
        ...
        <div class="flex flex-col gap-4 justify-center items-center px-2">
            ...
            <div x-data="{ search: @entangle('search') }" class="relative w-full md:max-w-3xl">
                ...
                <input type="text" x-model="search" wire:model.live.debounce.150ms="search" placeholder="Cari lokasi service center" class="w-full bg-[#F4F4F4] rounded-3xl text-lg outline-none font-medium pl-16 pr-8 py-[18px] placeholder:font-medium placeholder:text-[#868686]">
        ...
        <div class="flex flex-col gap-8 lg:flex-row">
            ...
            <template x-if="$store.placeDetailDrawer?.embed_map">
                <div class="flex items-center justify-center lg:hidden">
                    ...
                    <span class="flex-1 text-center mx-3 text-xs text-[#6D6D6D]">Daftar Service Center</span>
                    <div class="flex-1 w-full h-px bg-black/10"></div>
                </div>
            </template>
            {{-- Service Center List --}}
